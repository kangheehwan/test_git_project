...
<div id="container">
      ...
      <div id="contentCare">
      <form name="findAllboard" method="post" action="Controller?action=findBoardAllOwner">
        <input type="image" src="images/list.jpg"
		style="position: relative;top:140px;margin-left:500px;"  width="300px"height="95px"  >
        </form>
