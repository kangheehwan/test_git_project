...
<div id="container">
      <div id="header">
        <div id="mainlogo">
			...
			<a href="Controller?action=findManagerBylogin" class="topside">개인정보 확인&수정</a>
			</div>
		...
		<div style="position: relative; top: 100px;margin-left:400px; ">
			...
			<div id="enrollCheckManager">
				...
				이 름&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name"
					  placeholder=" 새로운 이름을 입력해주세요."style="margin: 5px" ><br>
				...
				<br> 돌봄지역<input type="text" name="possibleArea"
					 placeholder=" 새로운 돌봄지역을 입력해주세요." style="margin: 5px"><br>
			    ...
			    <br> 돌봄경험<input type="text" name="carrier"
					 placeholder=" 돌봄경험을 수정해주세요."style="margin: 5px"><br>
