...
<body>
      <form name="findIdForm" method="post" action="Controller?action=ownerFindId">
	...
	<form name="findPwForm" method="post" action="Controller?action=ownerFindPw">
		<div 
			style="position: relative; bottom: 80px; right: 80px; margin: 5px">비밀번호검색</div>
		<input type="text" name="userId" placeholder="당신의 아이디를 입력해주세요"
			style="position: relative; bottom: 70px; right: 50px; margin: 5px"><br>
		<input type="text" name="mobile" placeholder="ex)010-1234-1234"
			style="position: relative; bottom: 70px; right: 50px; margin: 5px"><br>
