	...
	<form name="checkManagerInfoForm" method="post" action="updateManagerInfo.jsp">
		<div style="position: relative; top: 100px;margin-left:400px; ">
			...
			<div id="enrollCheckManager">
				...
				<br> 자격번호<input type="text" name="cNumber"
					value=<%= member.getcNumber()%> style="margin: 5px" readonly><br>
				...
				<br> 돌봄지역<input type="text" name="possibleArea"
					 value="<%= member.getPosssibleArea()%>" style="margin: 5px"readonly><br>
			
				<br> 거주환경<input type="text" name="enviroment"
					 value="<%= member.getEnviroment()%>" style="margin: 5px"readonly><br>
					 
			    <br> 돌봄경험<input type="text" name="carrier"
					 value="<%= member.getCarrier()%>" style="margin: 5px"readonly><br>
				 
				<br> 돌봄여부<input type="text" name="careDog"
					 value="<%= member.getDogCare()%>" style="margin: 5px"readonly><br>
			
			
				<br> <br> <input type="image"src="images/fix.jpg"
					style="position: relative; top: 5px; left: 120px;" width="100px"
					height="50px" onclick="document.checkManagerInfoForm.submit()">
